...
var ReactRouterGA = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(ReactRouterGA, [{
    ...
    value: function sendPageView(location) {
      ...
      var pathname = this.props.basename ? "".concat(this.props.basename).concat(location.pathname) : location.pathname; // When appendQuery option is true, sets the query string.

      var query = this.props.appendQuery ? location.search : "";
      var page = "".concat(pathname).concat(query);
